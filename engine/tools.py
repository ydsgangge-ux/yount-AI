...
@register_tool(
    "simlife_action",
    "在SimLife死亡模式中执行你自己的行动指令。战斗场景可用：攻击/防御/使用技能/逃跑。非战斗场景可用：探索/移动/与NPC对话/休息恢复/搜索物品/调查周围/采集资源/打开宝箱/阅读/观察/思考。用第一人称描述你想做的事。注意：你只能描述你自己的行动，不能替用户角色做决定。",
    {
        "action": {"type": "string", "description": "你想执行的自己的行动，用第一人称描述。战斗示例：我攻击哥布林 / 我防御 / 我使用火球术 / 我逃跑。非战斗示例：我探索周围 / 我向前走 / 我和NPC对话 / 我休息一下 / 我搜索这个房间 / 我观察四周", "required": True},
    },
    risk="low"
)
